...
export default class Artists extends React.Component {
  ...
  async componentDidMount() {
    const artists = await this.props.fetchAPI(`https://desi-music-player.herokuapp.com/api/artists/`, {});
  ...
  loadArtist = async (artist) => {
    // change this below
    const response = await this.props.fetchAPI(`https://desi-music-player.herokuapp.com/api/artists/artist/${artist.id}/essentials/`, {});
